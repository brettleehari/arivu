...
This product bundles the Qwen3-1.7B model weights, Copyright 2024 Alibaba Cloud, Apache License 2.0,
as the Q4_K_M GGUF quantization published by Unsloth (huggingface.co/unsloth/Qwen3-1.7B-GGUF), named
qwen3-1.7b-q4_k_m.gguf in the app bundle and otherwise unmodified by Arivu.

 ...
 * end up as an uncompressed asset read through AssetManager.openFd(). Which GGUF is named by the
 * device's profile, not by this class (spine: C11).
 */
 ...
 */
class PadInstallTimeModelSource(private val context: Context, private val asset: String) : ModelSource {
...
class EmbeddedApkModelSource(
    @Suppress("unused") private val context: Context,
    @Suppress("unused") private val asset: String,
) : ModelSource {
    override fun open(): ModelWindow =
